...
public class ActorService {
	...
	// 배우 리스트 불러오기 - 이름 검색
	public Map<String, Object> getActorListByName(String name, int currentPage, int rowPage){
		Map<String, Object> map = null;
		List<Actor> list = null;
		Connection conn = null;
		ActorDao actorDao = null;
		...
		try {
			...
			// 배우 목록과 마지막 페이지 가져오기
			list = actorDao.selectActorListByName(conn, name, currentPage, rowPage);
			int endPage = actorDao.selectActorEndPageByName(conn, name, rowPage);
	...
	public void addActor(Actor actor) {
		...
		try {
			...
			actorDao.insertActor(conn, actor);
	...
	public void modifyActor(Actor actor) {
		...
		try {
			...
			actorDao.updateActor(conn, actor);
