	...
	<div class="row">
		...
		<div class="col-sm-9 bg-white mt-5 mb-5">
			...
			<div style="margin-top: 30px">
				<form id="addActorForm" action="${pageContext.request.contextPath}/auth/ModifyActorServlet" method="post">
					<input type="hidden" class="form-control" name="actorId" value="${actor.actorId}">
					<table class="table">
						<tr>
							<th width="20%">firstName</th>
							<td><input type="text" class="form-control" id="firstName" name="firstName" value="${actor.firstName}"></td>
						</tr>
						<tr>
							<th>lastName</th>
							<td><input type="text" class="form-control" id="lastName" name="lastName" value="${actor.lastName}"></td>
						</tr>
						<tr>
							<td colspan="2">
								<button class="btn btn-primary" id="addActorBtn" type="button">수정완료</button>
							</td>
						</tr>
					</table>
				</form>
